  ...
  return (
    <section className="relative h-full w-full bg-[#fff] pt-12 md:pt-24">
      <div className="flex flex-col gap-8 md:gap-20">
        {/* big screen */}
        <div className="hidden w-full flex-col gap-4 px-4 md:flex md:px-[60px] 2xl:px-[120px]">
        ...
        {/* mobile screen */}
        <div className="flex w-full flex-col gap-4 px-4 md:hidden md:px-[60px] 2xl:px-[120px]">
